...
AquaPi for ESPHome (MQTT) is a project that helps you build a powerful aquarium monitoring and automation system using affordable [**ESPHome**](https://esphome.io/) devices and [**Home Assistant**](https://www.home-assistant.io/installation/).
It connects to a private MQTT server.
...
<esp-web-install-button manifest="firmware/aquapi-mqtt.manifest.json"></esp-web-install-button>  
