...
> [!NOTE] 
> [**Install**](https://therealfalsereality.github.io/aquapi_mqtt/) | [**MQTT Configuration**](https://github.com/TheRealFalseReality/aquapi/wiki/MQTT-Server-Functionality)  
> This is merely a copy of [**AquaPi**](https://github.com/TheRealFalseReality/aquapi), visit that GitHub for the Wiki and most up to date informtaion. 
